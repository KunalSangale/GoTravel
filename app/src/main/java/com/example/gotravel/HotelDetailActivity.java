...
public class HotelDetailActivity extends AppCompatActivity {
    ...
    private TextView tTitle,tAddress,tPrice,tDescription;
    Button submit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(HotelDetailActivity.this,"Failed to load post",Toast.LENGTH_SHORT).show();
            }
        });
//        submit.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Toast.makeText(HotelDetailActivity.this,"Booking Confirmed",Toast.LENGTH_SHORT).show();
//            }
//        });
    }
}